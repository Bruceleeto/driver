...
int main(int argc, char** argv)
{
	...
	// initialise game/menu mappings from defaults set by PsyX_Initialise
	g_kbGameMappings = g_cfg_keyboardMapping;
	g_kbMenuMappings = g_cfg_keyboardMapping;
	g_gcGameMappings = g_cfg_controllerMapping;
	g_gcMenuMappings = g_cfg_controllerMapping;
